...
// function are objects like others, we can pass them as const copies
double compute_laplacian (const std::function<double(const nd_vector&)> & f , const nd_vector&, double h = 0.01);
