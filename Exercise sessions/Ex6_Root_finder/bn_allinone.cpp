...
real bisection(real a, real b,
  ...
  // nit is passed as a reference (not as a const reference) to change its value and see how many iterations
  // the method has taken to converge

  // (this fact is due to the impossibility to return multiple parameters by a function in c++)
  // (other solutions: struct, classes)
